namespace _04.WormsWorldParty
{
    ...
    public class Program
    {
        ...
        {
            Dictionary<string, Dictionary<string, int>> wormsParty =
            ...
            while (input != "quit")
            {
                ...
                {
                    wormsParty.Add(team, new Dictionary<string, int>());
            ...
            foreach (KeyValuePair<string, Dictionary<string, int>> kvp in orderedWormsParty)
            {
                string name = kvp.Key;
                Dictionary<string, int> worms = kvp.Value;
                int total = worms.Values.Sum();
